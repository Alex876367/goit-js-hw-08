...
//* Template-funtion and create elements
...
const galleryItemsTemplate = images.map(el => createGalleryCardTemplate(el)).join('');
galleryList.innerHTML = (galleryItemsTemplate);
